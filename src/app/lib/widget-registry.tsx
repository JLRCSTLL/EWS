...
export const WIDGETS = {
  map: {
    ...
    icon: <Shield className="h-4 w-4 text-zinc-100" />,
  ...
  'disaster-feed': {
    title: 'INCIDENT/DISASTER FEED',
    libraryTitle: 'Incident/Disaster Feed',
  ...
  responders: {
    ...
    icon: <Users className="h-4 w-4 text-zinc-200" />,
    headerColor: 'text-zinc-200',
    defaultSize: { w: 4, h: 4 },
    minSize: { w: 2, h: 3 },
  ...
  'system-health': {
    ...
    icon: <Activity className="h-4 w-4 text-zinc-200" />,
    headerColor: 'text-zinc-200',
    defaultSize: { w: 4, h: 3 },
    minSize: { w: 3, h: 2 },
  ...
  messaging: {
    ...
    icon: <MessageSquare className="h-4 w-4 text-zinc-200" />,
    headerColor: 'text-zinc-200',
    defaultSize: { w: 4, h: 4 },
    minSize: { w: 2, h: 3 },
  ...
  'audit-logs': {
    ...
    icon: <FileText className="h-4 w-4 text-zinc-100" />,
    headerColor: 'text-zinc-100',
    defaultSize: { w: 4, h: 3 },
    minSize: { w: 2, h: 2 },
