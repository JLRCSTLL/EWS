      ...
      <div className="border-b border-cyan-900/30 bg-gradient-to-r from-slate-900 to-slate-950 p-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-mono tracking-wider text-orange-400">RISK AND VULNERABILITY</h2>
          </div>
          <div className="flex items-center gap-2">
          ...
          {riskAreas.map((area) => (
            ...
            >
              <div className="flex items-start justify-between gap-2">
                ...
                <div className={`rounded px-2 py-1 text-xs font-mono ${getStatusColor(area.status)}`}>{area.status.toUpperCase()}</div>
              </div>
